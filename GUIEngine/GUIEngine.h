...
public:
	...
	BOOL GUICreatePicture(tagPOINT Pos,
		int width, int Height, ControlEventType eveType, int ControlID, LPTSTR filePath);
	//創建背景
...
BOOL GUIManager::GUICreatePicture(tagPOINT Pos,
	int width, int Height, ControlEventType eveType, int ControlID, LPTSTR filePath)
{
	cPicture* pic = new cPicture(Pos, width, Height, eveType, ControlID);
	if (pic == nullptr)
	{
		return false;
	}
...
BOOL GUIManager::GUICreateButton(
	tagPOINT Pos,
	int width, int Height, ControlEventType eveType, int ControlID, LPTSTR filePath, cCallBackFunctorBasic* pFunctor)
{
	cButton* button = new cButton(Pos, width, Height, eveType, ControlID, filePath, pFunctor);
